...
### Changed
- Replaced manual Windows spawn handling with `cross-spawn` package for cross-platform compatibility
- Removed custom `escapeWinArg` function - no longer needed with cross-spawn

### Security
- Fixed potential command injection vulnerabilities in Windows shell escaping
